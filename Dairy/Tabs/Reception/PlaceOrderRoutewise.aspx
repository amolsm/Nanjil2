                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtQuantity" class="form-control Orderqty" ValidationGroup="saved" ToolTip="Quantity"  placeholder="Quantity" onkeypress="return isNumberKey(event)" runat="server" ></asp:TextBox>                        
                    </div><!-- /.input group -->
