                  ...
                  <div class="form-group frmgrp" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtNewQuantity" class="form-control Orderqty" ToolTip="Quantity"  placeholder="Quantity" runat="server" onkeypress="return isNumberKey(event)"></asp:TextBox>                        
                    </div><!-- /.input group -->
