<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehiclewiseOperationStatementReport.aspx.cs" Inherits="Dairy.Tabs.Procurement.VehiclewiseOperationStatementReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <section class="content-header">
          <h1>
         Vehiclewise Operation Statement Report
            <small>Procurement</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Procurement</a></li>
            <li class="active"> <asp:Label runat="server" ID="lblHeaderTab" Text="Vehiclewise Operation Statement Report"></asp:Label> </li>
          </ol>
        </section>
     <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lblTabName" runat="server" Text="Vehiclewise Operation Statement Report"></asp:Label> </h3>
        ...
        <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <asp:DropDownList ID="dpVehicleNo" class="form-control" DataTextField="VehicleNo" DataValueField="VehicleMasterID" ToolTip="Select Vehicle No." runat="server"> 
                       </asp:DropDownList>  
