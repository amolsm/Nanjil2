<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RawMilkPurchaseBill.aspx.cs" Inherits="Dairy.Tabs.Procurement.RawMilkPurchaseBill" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <section class="content-header">
          <h1>
            Raw Milk Purchase Bill Report
            <small>Procurement</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Procurement</a></li>
            <li class="active"> <asp:Label runat="server" ID="lblHeaderTab" Text=" Raw Milk Purchase Bill Report"></asp:Label> </li>
          </ol>
        </section>
     <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lblTabName" runat="server" Text="Raw Milk Purchase Bill"></asp:Label> </h3>
        ...
        <div class="box-header" style="padding:0px 0px 0px 10px !important">
          <h3 class="box-title">Raw Milk Purchase Bill Report</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
