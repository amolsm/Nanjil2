...
namespace Dairy.Tabs.Sales
{
  ...
  Page.Request.Headers["Cookie"].IndexOf("ASP.NET_SessionId") >= 0)
        ...
        protected void dpAgentpre_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DS = BindCommanData.BindTypeDropDwon("Products.productId", "Products.ProductName+' '+Products.Productcode as product", "Products", "BindSlab", "Products.TypeID = Bindslab.TypeID", " BindSlab.AgentID =" + Convert.ToInt32(dpAgent.SelectedItem.Value) + " and BindSlab.SlabID = Products.SlabID order by Products.ProductName");
            ...
            DS = BindCommanData.BindCommanDropDwon("AgentID", "PaymentMode", "AgentMaster", "AgentID=" + Convert.ToInt32(dpAgent.SelectedItem.Value));
            dpPaymentMode.DataSource = DS;
