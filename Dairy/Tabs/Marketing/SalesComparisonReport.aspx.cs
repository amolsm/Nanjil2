...
{
    public partial class SalesComparisonReport : System.Web.UI.Page
    {
        ...
        protected void btngenrateBill_Click(object sender, EventArgs e)
        {
            ...
            DS = marketingdata.SalesComparisionreportItemwisebyDate((Convert.ToDateTime(txtStart1Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEnd1Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtStart2Date.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEnd2Date.Text)).ToString("dd-MM-yyyy"), Convert.ToInt32(dpRoute.SelectedItem.Value), Convert.ToInt32(dpBrand.SelectedValue));
            if (!Comman.Comman.IsDataSetEmpty(DS))
            {
                ...
                try
                {
                    ...
                    sb.Append("<b><u>Sales Comparison Reports </u> </b><br/>");
