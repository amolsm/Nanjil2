...
{
    public partial class SalesAnalysisItemwiseForBoothandPlant : System.Web.UI.Page
    {
        ...
        protected void btngenrateBill_Click(object sender, EventArgs e)
        {
            ...
            DS = marketingdata.SalesAnalysisitemwiseByDateForPlantandBooth((Convert.ToDateTime(txtStartDate.Text)).ToString("dd-MM-yyyy"), (Convert.ToDateTime(txtEndDate.Text)).ToString("dd-MM-yyyy"),  Convert.ToInt32(dpBrand.SelectedValue));
