<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocalBilling.aspx.cs" Inherits="Dairy.Tabs.OfflineBooth.LocalBilling" %>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtCustamerorderDate"  class="form-control"  placeholder="Date" runat="server" disabled></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtcustomerqty" class="form-control Orderqty" onkeypress="return isNumberKey(event)"   placeholder="Quantity " runat="server" ValidationGroup="Add"></asp:TextBox>                        
                    </div><!-- /.input group -->
