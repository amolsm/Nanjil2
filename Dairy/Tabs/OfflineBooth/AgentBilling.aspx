<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgentBilling.aspx.cs" Inherits="Dairy.Tabs.OfflineBooth.AgentBilling" %>
                 ...
                 <div class="form-group">
                   <div class="input-group">
                     <div class="input-group-addon">
                      ...
                      <asp:TextBox ID="txtGentOrderDate" class="form-control"   placeholder="Date" runat="server" disabled></asp:TextBox>                        
                   </div><!-- /.input group -->
