<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoothPlaceOrder.aspx.cs" Inherits="Dairy.Tabs.OfflineBooth.BoothPlaceOrder" %>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtagentOrderqty" class="form-control Orderqty" onkeypress="return isNumberKey(event)"   placeholder="Quantity " runat="server" ></asp:TextBox>                        
                    </div><!-- /.input group -->
