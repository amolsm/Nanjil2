<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenerateThermalBillGetInPdf.aspx.cs" Inherits="Dairy.Tabs.Administration.GenerateThermalBillGetInPdf" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> Generate Bill  In Pdf</li>
          </ol>
        </section>
           ...
           <div class="col-lg-3">
              ...
              <div class="col-lg-3">
                 ...
                 <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                               <asp:Button ID="btngenrateBillinPdf" class="btn btn-primary" runat="server" CommandName="MoveNext" OnClick="btngenrateBillinPdf_Click"   Text="Generate"    />     
