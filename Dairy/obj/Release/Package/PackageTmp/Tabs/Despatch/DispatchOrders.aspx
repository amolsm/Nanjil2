<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DispatchOrders.aspx.cs" Inherits="Dairy.Tabs.Despatch.DispatchOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtQuantity" class="form-control Orderqty" ValidationGroup="edit"  onkeypress="return isNumberKey(event)"  ToolTip="Quantity" placeholder="Quantity" runat="server" ></asp:TextBox>                        
                    </div><!-- /.input group -->
  ...
  <div class="modal-dialog" role="document">
    ...
    ValidationGroup="mgrp" runat="server" ControlToValidate="dpSalesman" ForeColor="Red"
    ...
    ValidationGroup="mgrp" runat="server" ControlToValidate="dpDriver" ForeColor="Red"
    ...
    ValidationGroup="mgrp" runat="server" ControlToValidate="dpVehicle" ForeColor="Red"
    ErrorMessage="Please Select Vehicle "></asp:RequiredFieldValidator>--%>
              ...
              <div class="col-lg-6">
                  <div class="form-group" >
                    <div class="input-group">
                      ...
                      <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtTraysDispached"
        ErrorMessage="Trays Required" ValidationGroup="mgrp" ForeColor="Red"></asp:RequiredFieldValidator> 
                                 <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtTraysDispached" ErrorMessage="Trays Must be &gt; 0" Operator="GreaterThan" Type="Double" ValueToCompare="0" ValidationGroup="mgrp" ForeColor="#cc0000"/>--%>
                  </div><!-- /.form group -->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          <asp:Button ID="btnSubmit" class="btn btn-primary" runat="server" ValidationGroup="mgrp" OnClick="btnSubmit_Click" Text="Save changes"  OnClientClick="Confirms()" />     
      </div>
    </div>
  </div>
</div>
