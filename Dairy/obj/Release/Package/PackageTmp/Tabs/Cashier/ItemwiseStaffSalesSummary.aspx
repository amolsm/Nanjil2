<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemwiseStaffSalesSummary.aspx.cs" Inherits="Dairy.Tabs.Cashier.ItemwiseStaffSalesSummary" %>
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:DropDownList ID="dpReportType" class="form-control"  runat="server" OnSelectedIndexChanged="dpReportType_SelectedIndexChanged" AutoPostBack="true" >
                    ...
                    <div class="input-group">
                      <div class="input-group-addon">
                       <i class="fa fa-rode"></i><span style="color:red">&nbsp;*</span>
                        ...
                        <asp:DropDownList ID="dpEmployee" class="form-control" DataTextField="Name" DataValueField="ID" runat="server" ValidationGroup="Save" > 
                       </asp:DropDownList>
