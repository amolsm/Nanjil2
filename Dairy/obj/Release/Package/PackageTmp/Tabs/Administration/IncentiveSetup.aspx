<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncentiveSetup.aspx.cs" Inherits="Dairy.Tabs.Administration.IncentiveSetup" %>
               ...
               <ItemTemplate>
                    <tr>
                         ...
                         <td><%# dpRoute.SelectedItem.Text%></td>
                           ...
                           <td> <asp:TextBox runat="server" ID="txtPreviousInc" ToolTip="Previous Incentive Amount" ReadOnly="true" Text='<%#(String.IsNullOrEmpty(Convert.ToDecimal(Eval("IncentiveAmt")).ToString("###.##")) ? " Not Set" :Convert.ToDecimal(Eval("IncentiveAmt")).ToString("###.##"))%>' />
                                  </td>
