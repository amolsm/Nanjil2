<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgentwiseTraysReport.aspx.cs" Inherits="Dairy.Tabs.Administration.AgentwiseTraysReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          <h1>
        AgentWise Return Trays Report
            <small>Administration</small>    
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">AgentWise Return Trays Return</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="AgentWise Return Trays Report"></asp:Label> </h3>
                 ...
                 <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                        ...
                        &nbsp; <asp:Button ID="btnPrint" class="btn btn-primary" runat="server" CommandName="MoveNext"  Text="Print"   OnClientClick="return PrintPanel();" />     
