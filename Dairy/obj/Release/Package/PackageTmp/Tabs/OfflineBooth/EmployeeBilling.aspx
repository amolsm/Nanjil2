<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeBilling.aspx.cs" Inherits="Dairy.Tabs.OfflineBooth.EmployeeBilling" %>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtEmployeeOrderDate"  class="form-control"   placeholder="Date" runat="server" disabled></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtQtyEmployee" class="form-control Orderqty" onkeypress="return isNumberKey(event)"   placeholder="Quantity " runat="server" ValidationGroup="Add"></asp:TextBox>                        
                    </div><!-- /.input group -->
