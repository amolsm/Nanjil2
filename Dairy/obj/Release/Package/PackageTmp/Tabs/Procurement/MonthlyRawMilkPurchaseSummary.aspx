<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonthlyRawMilkPurchaseSummary.aspx.cs" Inherits="Dairy.Tabs.Procurement.MonthlyRawMilkPurchaseSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <section class="content-header">
          <h1>
            Monthly Raw Milk Purchase Summary
            <small>Procurement</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Procurement</a></li>
            <li class="active"> <asp:Label runat="server" ID="lblHeaderTab" Text="Monthly Raw Milk Purchase Summary"></asp:Label> </li>
          </ol>
        </section>
     <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lblTabName" runat="server" Text="Monthly Raw Milk Purchase Summary"></asp:Label> </h3>
        ...
        <div class="box-header" style="padding:0px 0px 0px 10px !important">
          <h3 class="box-title">Monthly Raw Milk Purchase Summary</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                     ...
                     TS Start %
                       ...
                       <asp:TextBox ID="txttsstart" class="form-control" placeholder="TS Start Percentage" runat="server" type="number" step="any"  ToolTip="Start TS Percentage"></asp:TextBox>                        
                    </div><!-- /.input group -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                     ...
                     TS End %
                       ...
                       <asp:TextBox ID="txttsend" class="form-control" placeholder="TS End Percentage" runat="server" type="number" step="any"  ToolTip="End TS Percentage"></asp:TextBox>                        
                    </div><!-- /.input group -->
                 ...
                 <div class="col-lg-3">
                  ...
                  All TS %
                      ...
                      <asp:CheckBox ID="CheckBox1" class="form-control" placeholder="All TS %" runat="server"  ToolTip="All TS %"></asp:CheckBox>
                    </div><!-- /.input group -->
