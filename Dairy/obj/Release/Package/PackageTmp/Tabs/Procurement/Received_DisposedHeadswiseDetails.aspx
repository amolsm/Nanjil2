<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Received_DisposedHeadswiseDetails.aspx.cs" Inherits="Dairy.Tabs.Procurement.Received_Disposed_HeadswiseDeatils" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <section class="content-header">
          <h1>
         Received/Disposed HeadswiseDeatils
            <small>procurement</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> procurement</a></li>
            <li class="active"> <asp:Label runat="server" ID="lblHeaderTab" Text="Received/Disposed HeadswiseDeatils"></asp:Label> </li>
          </ol>
        </section>
     <section class="content">
          ...
          <!-- Default box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lblTabName" runat="server" Text="Received/Disposed HeadswiseDeatils"></asp:Label> </h3>
        ...
        <div class="box-header" style="padding:0px 0px 0px 10px !important">
          <h3 class="box-title">Received/Disposed HeadswiseDeatils</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
             ...
             <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpParticularType" class="form-control"  runat="server" OnSelectedIndexChanged="dpParticularType_SelectedIndexChanged" Autopostback="true" > 
