<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Mass Issue.aspx.cs" Inherits="Dairy.Tabs.Marketing.Mass_Issue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mass Issue details</li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text="Mass Issue"></asp:Label> </h3>
              ...
              <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpIssue" class="form-control" runat="server" DataValueField="IssueID" DataTextField="Issues"  ToolTip="Select Issue"  > 
                     <asp:ListItem Value="0">---AllIssues---</asp:ListItem>
                 ...
                 <div class="col-lg-3">
                  <div class="form-group">
                    <div class="input-group">
                        ...
                        <asp:Literal runat="server" ID="Issue"></asp:Literal>
              </asp:Panel>
