<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgentSlabReportList.aspx.cs" Inherits="Dairy.Tabs.Marketing.AgentSlabReportList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <section class="content-header">
          <h1>
         Agent Slab Report List 
             <small>Administration</small>  
          </h1> 
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Administration</a></li>
            <li class="active">   Agent Slab Report List  </li>
          </ol>
        </section>
             ...
             <div class="row">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpSlab" class="form-control" DataTextField="Name" DataValueField="SlabID" runat="server"  > 
                       </asp:DropDownList>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <asp:DropDownList ID="dpProductType" class="form-control" DataTextField="Name" DataValueField="TypeID" runat="server"  > 
                       </asp:DropDownList>
