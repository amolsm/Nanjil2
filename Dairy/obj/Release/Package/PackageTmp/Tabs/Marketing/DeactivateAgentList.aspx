<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeactivateAgentList.aspx.cs" Inherits="Dairy.Tabs.Marketing.DeactivateAgentList" %>
      ...
      <section class="content-header">
         ...
         Deactive Agent List 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">  Deactive Agent List </li>
          </ol>
        </section>
       ...
       <section class="content">
           ...
           <div class="box  ">
            <div class="box-header with-border">
              <h3 class="box-title"><asp:Label ID="lbltital" runat="server" Text=" Deactive Agent List "></asp:Label> </h3>
