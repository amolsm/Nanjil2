      ...
      <section class="content">
          ...
          <asp:Repeater ID="rpAgentOrderdetails" runat="server" OnItemDataBound="rpOrderitam_OnDataBinding" OnItemCommand="rpOrderitam_ItemCommand">
               ...
               <ItemTemplate>
                    ...
                    <FooterTemplate>
                          <tr id="trEmpty" runat="server" visible="false"><td  align = "left" colspan="10"><h5> Bulk Routewise Employee Order is completed for this Route Or No records found. Please contact Admin.</h5></td> </tr>
                         </tbody>
                  ...
                  <div class="form-group" >
                    <div class="input-group">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox ID="txtQuantity" class="form-control Orderqty" ValidationGroup="saved" ToolTip="Quantity" onkeypress="return isNumberKey(event)" placeholder="Quantity" runat="server" ></asp:TextBox>                        
                    </div><!-- /.input group -->
